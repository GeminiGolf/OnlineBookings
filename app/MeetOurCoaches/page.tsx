...
export default function MeetOurCoachesPage() {
  return (
    <main className="min-h-screen bg-[#121D16] text-[#F2EEE8]">
      ...
      <section className="relative flex overflow-hidden border-b border-[#2A3D30] px-6 pb-6 pt-20 sm:px-10 sm:pb-8 sm:pt-24 lg:px-14 lg:pb-10 lg:pt-28 text-[#F2EEE8]">
        <img
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl items-end justify-between">
          <div className="max-w-2xl">
            <h1 className="text-lg font-light uppercase tracking-[0.18em] sm:text-xl lg:text-2xl text-[#F2EEE8]">
              Meet Our Coaches
            </h1>
              ...
              >
                <div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <span className="text-[8px] min-[400px]:text-[9px] sm:text-[10px] font-light uppercase tracking-[0.16em] text-[#B89868]">
                      {coach.label}
                    </span>
                    <div className="h-[1px] w-4 sm:w-12 bg-[#2A3D30]" />
                  </div>

                  <h2 className="mt-1 sm:mt-2 text-xs min-[400px]:text-sm sm:text-xl lg:text-2xl font-light uppercase tracking-[0.12em] text-[#F2EEE8] truncate">
                    {coach.name}
                  </h2>
                  ...
                  <div className="mt-1 sm:mt-3">
                    <h3 className="text-[8px] min-[400px]:text-[9px] sm:text-[10px] font-light uppercase tracking-[0.16em] text-[#E0D8CC]/70">
                      Coaching Philosophy
                    </h3>
                    <p className="mt-0.5 text-[9px] min-[400px]:text-[10px] sm:text-xs lg:text-sm font-light leading-tight sm:leading-normal tracking-[0.02em] text-[#E0D8CC]">
                      {coach.philosophy}
                    </p>
                  </div>
                  ...
                  <div className="mt-1 sm:mt-3 hidden min-[480px]:block">
                    ...
                    <ul className="mt-0.5 space-y-0.5">
                      {coach.specialisations.map((item) => (
                        <li
                          key={item}
                          className="flex items-center gap-1 text-[8px] min-[400px]:text-[9px] sm:text-xs font-light tracking-[0.02em] text-[#E0D8CC]"
                        >
                          <span className="text-[5px] sm:text-[7px] font-light text-[#B89868]">◆</span>
                          {item}
                        </li>
                      ))}
                    </ul>
                ...
                <div className="mt-1.5 sm:mt-4 shrink-0">
                  <Link
                    ...
                    className="inline-flex items-center gap-1 sm:gap-2 rounded-lg border border-[#3A5D49] bg-[#121D16] px-2 py-1 sm:px-4 sm:py-2 text-[8px] min-[400px]:text-[9px] sm:text-xs font-light uppercase tracking-[0.14em] text-[#F2EEE8] shadow-sm transition hover:bg-[#253A2C] hover:border-[#B89868]"
                  >
                    View Availability →
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-xl">
          ...
          <div className="mt-5 sm:mt-6">
            <Link
              ...
              className="inline-block border border-[#B89868] bg-transparent px-5 py-2 text-[10px] font-light uppercase tracking-[0.18em] text-[#F2EEE8] transition hover:bg-[#B89868] hover:text-[#121D16] sm:px-6 sm:py-2.5 sm:text-xs"
            >
              Book A Lesson
            </Link>
          </div>
