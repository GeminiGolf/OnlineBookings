...
export default function CoachNavbar({
  ...
  <>
    ...
    {/* Side Menu Drawer */}
    <div
      className={`fixed top-0 right-0 z-50 flex h-screen w-80 flex-col text-white shadow-2xl border-l border-[#D8CCB7]/15 transition-transform duration-300 ease-in-out ${
        isHomePage
